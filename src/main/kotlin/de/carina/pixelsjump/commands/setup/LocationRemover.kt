    ...
    fun execute() {
        ...
        when (args[2].lowercase()) {
            "start" -> {
                ...
                sender.sendMessage(Messages.messages["start-location-removed"]!!.replace(ConstantStrings.ARENA_PERCENT, args[1]))
            ...
            "back" -> {
                ...
                sender.sendMessage(Messages.messages["back-location-removed"]!!.replace(ConstantStrings.ARENA_PERCENT, args[1]))

            }

            "finish" -> {
                arena.endLocation = null
                sender.sendMessage(Messages.messages["end-location-removed"]!!.replace(ConstantStrings.ARENA_PERCENT, args[1]))
            }
